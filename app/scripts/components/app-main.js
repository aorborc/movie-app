...
class App extends Component {
  ...
  fetchMovieID(movieID) {
    let url = `https://api.themoviedb.org/3/movie/${movieID}?api_key=ada6d6eb6082d9a2fe9f7c7762b87fc2&append_to_response=credits`
    this.fetchApi(url)
  } // end function

  componentDidMount() {
    let url = `https://api.themoviedb.org/3/movie/${this.state.movieID}?api_key=ada6d6eb6082d9a2fe9f7c7762b87fc2&append_to_response=credits`
    this.fetchApi(url)
